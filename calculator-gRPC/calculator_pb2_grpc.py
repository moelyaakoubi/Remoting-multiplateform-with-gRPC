...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                ...
                request_serializer=calculator__pb2.ArithmeticRequest.SerializeToString,
                response_deserializer=calculator__pb2.ArithmeticResponse.FromString,
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Add': grpc.unary_unary_rpc_method_handler(
                    servicer.Add,
                    request_deserializer=calculator__pb2.ArithmeticRequest.FromString,
                    response_serializer=calculator__pb2.ArithmeticResponse.SerializeToString,
            ),
...
class Calculator(object):
    ...
    def Add(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/calculator.Calculator/Add',
            calculator__pb2.ArithmeticRequest.SerializeToString,
            calculator__pb2.ArithmeticResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
